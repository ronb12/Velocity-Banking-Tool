...
self.addEventListener('install', event => {
  ...
  // CRITICAL: DO NOT skip waiting automatically - wait for user confirmation
  // This prevents aggressive reloads that cause loops
  // The service worker will remain in 'installing' state until user confirms update
  // This prevents automatic activation and reload loops
});
