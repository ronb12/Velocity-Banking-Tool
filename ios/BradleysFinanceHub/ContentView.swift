...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .task {
            print("ContentView: Appeared, isAuthenticated=\(authService.isAuthenticated), requiresBiometric=\(authService.requiresBiometricAuth)")
...
// MARK: - OnboardingView (included here because OnboardingView.swift is not in Xcode project target)
