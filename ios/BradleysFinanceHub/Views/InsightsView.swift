...
//  BradleysFinanceHub
//
//  Consolidated view for Charts, Net Worth, Activity, and Reports
//
...
// MARK: - AIInsightsView (included here because AIInsightsView.swift is not in Xcode project target)
